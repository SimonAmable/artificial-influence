...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-[85%] flex-col gap-2 overflow-hidden rounded-2xl px-4 py-3 text-sm",
      "group-[.is-user]:bg-foreground group-[.is-user]:text-background",
      "group-[.is-assistant]:border group-[.is-assistant]:border-border/60 group-[.is-assistant]:bg-muted/40 group-[.is-assistant]:text-foreground",
      className,
    )}
    {...props}
  >

...
function detectSpeechInputMode(options: {
  forceServerTranscription?: boolean;
  hasOnAudioRecorded: boolean;
}): SpeechInputMode {
  ...
  if (
    options.forceServerTranscription &&
    options.hasOnAudioRecorded &&
...
export const SpeechInput = ({
  ...
  const [mode] = useState<SpeechInputMode>(() =>
    detectSpeechInputMode({
      forceServerTranscription,
      hasOnAudioRecorded: Boolean(onAudioRecorded),
    }),
  );
      ...
      const handleStop = async () => {
        ...
        if (audioBlob.size > 0 && onAudioRecordedRef.current) {
          ...
          try {
            ...
            onTranscriptionErrorRef.current?.(err);
          } finally {

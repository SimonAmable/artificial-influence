...
export function MotionCopyShowcaseCard({
  ...
  if (isRowLayout) {
    return (
      <div className={cn("w-full min-h-full flex flex-col motion-copy-showcase-card overflow-visible", className)}>
        <div className="flex flex-col gap-4 p-4 md:p-4 pb-4 justify-start motion-copy-showcase-content overflow-visible">
          {content}
        </div>
      </div>
    )
  ...
  return (
    <Card className={cn("w-full min-h-full flex flex-col motion-copy-showcase-card border-none shadow-none bg-transparent py-0 overflow-visible", className)}>
      <CardContent className="flex flex-col gap-4 p-4 md:p-4 pb-4 justify-start motion-copy-showcase-content overflow-visible">
        {content}
      </CardContent>
    </Card>
  )

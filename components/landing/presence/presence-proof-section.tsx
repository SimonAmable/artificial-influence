...
function ProofMarquee({ images, priority = false }: ProofMarqueeProps) {
  ...
  return (
    <div
      className="proof-marquee-lane relative h-[var(--proof-card-height)] overflow-hidden"
      aria-label="Scrolling proof screenshots"
    >
...
export function PresenceProofSection() {
  return (
    <section
      id="proof"
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <h2 className="text-3xl font-semibold text-foreground sm:text-4xl">
            {presenceLandingCopy.proof.title}
          </h2>
        </div>

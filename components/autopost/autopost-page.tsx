  ...
  return (
    <div className="min-h-screen bg-background px-4 pb-8 pt-20 md:pt-24">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        ...
        <section className="rounded-3xl border border-border/60 bg-muted/10 px-4 py-3">
          <p className="text-sm text-muted-foreground">
            Account management moved to <span className="font-medium text-foreground">Profile → Accounts</span> to keep this page focused
            on composing and scheduling posts.
          </p>
        </section>

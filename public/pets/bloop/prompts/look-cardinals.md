Create one horizontal four-cardinal anchor strip for Codex pet `bloop`.
...
Place one pose in each invisible equal-width slot on a flat pure orange #FF7F00 background with generous padding. Keep scale, feet/base, lower body, and registration consistent across all four slots.

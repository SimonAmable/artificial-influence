...
export const CHARACTER_SWAP_TOOL: ImageStudioToolDefinition = {
  ...
  canonicalPrompt:
    ...
    "Strictly preserve the exact pose, body positioning, limb placement, gesture, overall stance, facial expression, mouth shape, and emotion from the second image. " +

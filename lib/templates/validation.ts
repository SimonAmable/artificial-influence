...
export const createTemplateBodySchema = z.object({
  ...
  preview_layout: z.enum(["single", "before_after"]).optional(),
  preview_before_url: z.string().url().nullable().optional(),
  preview_before_kind: z.enum(["image", "video"]).nullable().optional(),

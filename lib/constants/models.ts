...
export const P_VIDEO_MODEL: Model = {
  id: 'model-pruna-p-video',
  identifier: MODEL_IDENTIFIERS.PRUNAAI_P_VIDEO,
  name: 'P-Video',
  description:
    'Pruna AI unified video model for text-to-video, image-to-video, and audio-conditioned video generation.',
  type: 'video',
  provider: 'replicate',
  is_active: true,
  model_cost: 10,

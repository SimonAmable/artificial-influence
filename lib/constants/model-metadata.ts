...
export const GPT_IMAGE_2_META: ModelMetadata = {
  ...
  name: 'GPT Image 2',
  description: 'OpenAI image generation on Replicate with strong prompt following, crisp text rendering, and high-fidelity edits.',
  type: 'image',
  provider: 'replicate',
  is_active: true,
  model_cost: 4.0,
  ...
  customParameters: [
    {
      ...
      default: 'low',
      description: 'Generation quality preset. Lower quality is faster and cheaper.',
    },
    {
      name: 'moderation',
      label: 'Moderation',

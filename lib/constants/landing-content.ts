...
export const platformSurfaceCards: LandingPlatformSurfaceCard[] = [
  {
    ...
    id: "agent",
    name: "Agents",
    sectionBlurb: "Use our creative agent to make or remix standout content with natural language.",
    description:
  ...
  },
  {
    ...
    id: "generator",
    name: "Generators",
    sectionBlurb: "20+ SOTA models for images and video.",
  ...
  },
  {
    ...
    id: "workflow",
    name: "Workflows",
    sectionBlurb: "Reusable flows you edit, group, and rerun.",
  ...
  },
  {
    ...
    id: "automation",
    name: "Automations",
    sectionBlurb: "Connect Instagram and publish on your schedule.",

-- Wan 2.7 Image on Fal: single catalog id routed to text-to-image or edit.
...
INSERT INTO public.models (
  ...
  'fal-ai/wan/v2.7',
  'Wan 2.7 Image',
  'WAN 2.7 on fal: text-to-image, or attach reference image(s) for image editing (same selector item; backend picks text-to-image vs edit endpoint). Safety checker is disabled by default.',
  'image',
  'fal',
  true,
  4,
...
SET agent_usage = $json${
  "agentSummary": "Fal-hosted WAN 2.7 unified image generation/editing model. Backend routes fal-ai/wan/v2.7 to text-to-image when there are no references, or edit when reference images are attached.",
  "bestFor": ["high-quality text-to-image", "text-guided image edits", "style transformations", "creative image manipulation", "Chinese and English prompts"],
  "avoidFor": ["masked inpainting workflows", "video", "transparent-background promises", "more than 4 output variants"],
  "inputSemantics": {
  ...
  "routingRules": [
    "Use the canonical catalog id fal-ai/wan/v2.7, never fal-ai/wan/v2.7/text-to-image or fal-ai/wan/v2.7/edit.",
...
WHERE identifier = 'fal-ai/wan/v2.7';
